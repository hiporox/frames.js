...
The issue with the state used without any sort of signature is that it can be tampered with by the client. To prevent this, you can use a `stateSigningSecret` option to ensure that the state has not been tampered with.
